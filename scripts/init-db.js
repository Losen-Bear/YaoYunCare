...
(async () => {
  ...
  if ((c3[0] && c3[0].c === 0) || (!c3[0])) {
    await conn.query(
      ...
      ('清炒时蔬', '平和质', '["西兰花200g","胡萝卜100g","蒜末5g","盐2g","食用油5ml"]', '["1. 西兰花焯水1分钟，胡萝卜切条","2. 热锅倒油爆香蒜末","3. 放入胡萝卜翻炒2分钟","4. 加入西兰花再炒1分钟，加盐调味"]', ''),
      ('黄芪当归鸡汤', '气虚质', '["鸡肉500g","黄芪10g","当归5g","生姜3片","红枣4颗","盐3g","水1500ml"]', '["1. 鸡肉焯水洗净","2. 砂锅加水放入鸡肉、黄芪、当归、姜片、红枣","3. 大火煮沸后转小火炖90分钟","4. 加盐调味"]', ''),
      ('党参炒山药', '气虚质', '["党参10g(切段)","山药200g","瘦肉100g(切丝)","生抽5ml","盐2g","食用油5ml"]', '["1. 党参温水泡软，山药切丝焯水，瘦肉加生抽腌10分钟","2. 热锅倒油炒香瘦肉","3. 加入党参翻炒1分钟","4. 放入山药丝再炒2分钟，加盐调味"]', ''),
      ('羊肉萝卜汤', '阳虚质', '["羊肉300g(切块)","白萝卜200g(切块)","生姜5片","花椒3g","八角1颗","盐3g","水1500ml"]', '["1. 羊肉焯水去血沫","2. 砂锅加水放羊肉、姜片、花椒、八角，大火煮沸后小火煮60分钟","3. 加入白萝卜再煮30分钟","4. 加盐调味"]', ''),
      ('桂圆红枣姜茶', '阳虚质', '["桂圆肉10g","红枣6颗(去核)","生姜3片","红糖10g","水500ml"]', '["1. 姜片、红枣、桂圆洗净","2. 锅中加水放姜片、红枣、桂圆煮沸","3. 小火煮15分钟，加入红糖融化"]', ''),
      ('韭菜炒虾仁', '阳虚质', '["韭菜200g(切段)","虾仁150g","盐2g","料酒5ml","食用油5ml"]', '["1. 虾仁加料酒腌10分钟","2. 热锅倒油，下虾仁炒至变色","3. 加入韭菜段翻炒1分钟，加盐调味"]', ''),
      ('百合莲子粥', '阴虚质', '["百合15g(干)","莲子10g(去芯)","大米50g","冰糖5g(可选)","水800ml"]', '["1. 百合、莲子浸泡30分钟，大米淘洗","2. 锅中加水放入大米、百合、莲子","3. 小火熬煮40分钟，加冰糖调味"]', ''),
      ('凉拌藕', '阴虚质', '["莲藕200g(切片)","白醋5ml","白糖3g","盐1g","香油少许"]', '["1. 藕片焯水2分钟捞出过凉","2. 加白醋、白糖、盐、香油拌匀即可"]', ''),
      ('薏米红豆粥', '痰湿质', '["薏米30g","红豆20g","大米40g","水800ml"]', '["1. 薏米、红豆浸泡4小时，大米淘洗","2. 锅中加水煮沸放入所有食材","3. 小火熬煮40分钟至粥稠"]', ''),
      ('冬瓜海带排骨汤', '痰湿质', '["排骨200g(切块)","冬瓜150g(切块)","海带50g(泡发切段)","生姜2片","盐2g","水1500ml"]', '["1. 排骨焯水洗净","2. 砂锅加水放排骨与姜片煮沸后小火炖60分钟","3. 加入冬瓜、海带再炖20分钟","4. 加盐调味"]', ''),
      ('炒冬瓜', '痰湿质', '["冬瓜300g(切片)","蒜末5g","盐2g","食用油5ml"]', '["1. 热锅倒油爆香蒜末","2. 下冬瓜翻炒2分钟","3. 加少许水焖5分钟，加盐调味"]', ''),
      ('苦瓜炒蛋', '湿热质', '["苦瓜1根(去瓤切片)","鸡蛋2个","盐2g","食用油5ml"]', '["1. 苦瓜片焯水1分钟去苦味，鸡蛋打散加盐","2. 热锅倒油炒散鸡蛋盛出","3. 同锅少油下苦瓜翻炒2分钟","4. 加入鸡蛋翻匀即可"]', ''),
      ('赤小豆冬瓜汤', '湿热质', '["赤小豆20g","冬瓜200g(切块)","水600ml","盐1g"]', '["1. 赤小豆浸泡2小时","2. 锅中加水放赤小豆煮30分钟","3. 加入冬瓜再煮15分钟，加盐调味"]', '')`
    );
  }
